window.PLAYLIST = [
    {
        ...
        "introText": "<strong>Strategy:</strong> Use <code>mean([list])</code> and <code>median([list])</code> in Desmos for quick calculations. <strong>Trap:</strong> The mean is sensitive to outliers (extremely high or low values), while the median is 'robust' and stays stable.",
        "questions": {
            "guided": [
                {
                    "id": "4b09f783",
                ...
                },
                {
                    ...
                    "answer": "A",
                    "correctIndex": 0,
                    "explanation": "<strong>Rationale:</strong><br>Choice A is correct. A frequency table is a table that lists the data value and shows the number of times the data value occurs. In the data listed, the number occurs four times, the number occurs three times, and the number occurs two times. This corresponds to the table in choice A.",
                    "difficulty": "Easy",
                    "type": "multiple-choice",
                    "archetype": "Two-way table probability",
                    "trapName": "Used the grand total instead of the conditional total",
            ...
            "exam": [
                ...
                },
                {
                    ...
                    "answer": "D",
                    "correctIndex": 3,
                    "explanation": "<strong>Rationale:</strong><br>Choice D is correct. It's given that the bar graph shows the number of students from one school who were born in either July, August, September, or October. The bar representing the number of students born in August has a height of ; therefore, students were born in August. The bar representing the number of students born in July has a height of ; therefore, students were born in July. Thus, there were , or more students born in August than in July. Choice A is incorrect. This is the total number of students born in July and August.",
                    "difficulty": "Easy",
                    "type": "multiple-choice",
                    "archetype": "Standard deviation and spread",
                    "trapName": "Equated range with standard deviation",
    ...
    },
    {
        ...
        "introText": "<strong>Strategy:</strong> For scatterplots, look for the 'Line of Best Fit'. If the points trend up, it's a positive correlation. Use Desmos tables to visualize data trends and find the specific model (linear vs exponential) that fits best.",
        "questions": {
            "guided": [
                {
                    "id": "83272c51",
    ...
    },
    {
        ...
        "introText": "<strong>Strategy:</strong> Always identify your 'Target' and your 'Total'. <code>P = Favorable / Total</code>. For conditional probability (e.g., 'Given that the student is a senior...'), your 'Total' is restricted to ONLY that specific group!",
        "questions": {
            "guided": [
                {
                    "id": "46545dd6",
            ...
            "independent": [
                {
                    ...
                    "answer": "A",
                    "correctIndex": 0,
                    "explanation": "<strong>Rationale:</strong><br>Choice A is correct. It is given that there are 180 female penguins in the exhibit. Therefore, of the female penguins is penguins. According to the table, there are 59 female chinstrap penguins, 27 female emperor penguins, 54 female gentoo penguins, and 40 female macaroni penguins. So the female chinstrap penguin population is the closest to 60, or of the total female population in the exhibit.",
                    "difficulty": "Medium",
                    "type": "multiple-choice",
                    "archetype": "Two-way table probability",
                    "trapName": "Used the grand total instead of the conditional total",
                ...
                },
                {
                    ...
                    "answer": "B",
                    "correctIndex": 1,
                    "explanation": "<strong>Rationale:</strong><br>Choice B is correct. The sample space is restricted to the presidents who were at least 50 years old when they first took office. Therefore, the sum of the values in the final four rows of the table, , is the total number of presidents in the",
                    "difficulty": "Medium",
                    "type": "multiple-choice",
                    "archetype": "Two-way table probability",
                    "trapName": "Used the grand total instead of the conditional total",
