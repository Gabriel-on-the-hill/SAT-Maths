        ...
        "questions": {
            ...
            "independent": [
                ...
                },
                {
                    ...
                    "answer": "D",
                    "correctIndex": 3,
                    "explanation": "<strong>Rationale:</strong><br>Choice D is correct. A solution to the given inequality is a value of and the corresponding value of such that the value of is greater than the value of . All the tables in the choices have the same three values of , so each of the three values of can be substituted in the given inequality to compare the corresponding values of in each of the tables. Substituting for in the given inequality yields , or . Substituting for in the given inequality yields , or . Substituting for in the given inequality yields , or . Therefore, when , , and , the Assessment SAT Test Math Domain Algebra Skill Linear inequalities in one or two variables Difficulty",
                    "difficulty": "Medium",
                    "type": "multiple-choice",
                    "archetype": "Solve a one-variable linear inequality",
                    "trapName": "Forgot to flip the inequality when multiplying/dividing by a negative",
