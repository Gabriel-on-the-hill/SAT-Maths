(function () {
    const APP_ID = 'Nonlinear_Functions_App';
    const state = {
    ...
    function saveProgress(isFinal = false) {
        ...
        const appName = "Nonlinear_Functions_App";
    ...
    function init() {
        document.querySelectorAll('.module-btn').forEach(btn => {
            btn.addEventListener('click', () => startPlaylist(btn.dataset.module));
        });
    ...
    function handleCopyWork() {
        const name = "Student"; // Start screen name input was removed, but we can default or add back
