const QUESTIONS_DATA = {
    "guided": [
        ...
        },
        {
            ...
            "correctIndex": 2,
            "explanation": "<strong>SAT Strategy:</strong> Read the claim carefully. Does the sample represent the population?<br><br><strong>Algebraic Method:</strong> Choice C is correct. It’s given that an estimated of people in the population support the legislation, with an associated margin of error of . Subtracting and adding the margin of error from the estimate gives an interval of plausible values for the true percentage of people in the population who support the legislation. Therefore, it’s plausible that between and of people in this population support the legislation. The corresponding numbers of people represented by these percentages in the population can be calculated by multiplying the total population, , by and by , which gives and , respectively. It follows that any value in the interval to is a plausible value for the total number of people in the population who support the proposed legislation. Of the choices given, only is in this interval. Choice A is incorrect. This is the number of people in the sample, rather than in the population, who support the legislation. Choice B is incorrect. This is the number of people in the sample who do not support the legislation. Choice D is incorrect. This is a plausible value for the total number of people in the population who do not support the proposed legislation.<br><br><strong>🪤 Trap Alert:</strong> Beware of biased samples or small sample sizes.",
            "type": "multiple-choice",
            "archetype": "Margin of error / confidence interval",
            "trapName": "Said ",
            "strategy": "The interval (estimate − margin) to (estimate + margin) is the plausible range.",
        ...
        },
        {
            ...
            "correctIndex": 1,
            "explanation": "<strong>SAT Strategy:</strong> Read the claim carefully. Does the sample represent the population?<br><br><strong>Algebraic Method:</strong> Choice B is correct. It's given that based on a sample selected at random, it's estimated that of all adults who own televisions use their televisions to watch nature shows, with an associated margin of error of . Subtracting the margin of error from the estimate and adding the margin of error to the estimate gives an interval of plausible values for the true percentage of adults who own televisions who use their televisions to watch nature shows. This means it's plausible that between , or , and , or , of all adults who own televisions use their televisions to watch nature shows. Therefore, of the given choices, the most plausible conclusion is that between and of all adults who own televisions use their televisions to watch nature shows. Choice A is incorrect and may result from conceptual errors. Choice C is incorrect. To make a plausible conclusion about all adults who own televisions, the sample must be selected at random from all adults who own televisions, not just those who use their televisions to watch nature shows. Choice D is incorrect. Since the sample was selected at random from all adults who own televisions, a plausible conclusion can be made about all adults who own televisions.<br><br><strong>🪤 Trap Alert:</strong> Beware of biased samples or small sample sizes.",
            "type": "multiple-choice",
            "archetype": "Margin of error / confidence interval",
            "trapName": "Said ",
            "strategy": "The interval (estimate − margin) to (estimate + margin) is the plausible range.",
        ...
        },
        {
            ...
            "correctIndex": 1,
            "explanation": "<strong>SAT Strategy:</strong> Read the claim carefully. Does the sample represent the population?<br><br><strong>Algebraic Method:</strong> Choice B is correct. The largest group to which the results of a study can be generalized is the population from which the random sample was chosen. In this case, the psychologist chose a random sample from all students at one particular middle school. Therefore, the largest group to which the results can be generalized is all the students at the school. Choice A is incorrect because this isn’t the largest group the results can be generalized to. Choices C and D are incorrect because these groups are larger than the population from which the random sample was chosen. Therefore, the sample isn’t representative of these groups.<br><br><strong>🪤 Trap Alert:</strong> Beware of biased samples or small sample sizes.",
            "type": "multiple-choice",
            "archetype": "Random sample → generalise to population",
            "trapName": "Generalised beyond the sampled group",
            "strategy": "Compute the proportion in the sample (e.g., 6 out of 20 = 30%).",
    ...
    "independent": [
        ...
        },
        {
            ...
            "correctIndex": 3,
            "explanation": "<strong>SAT Strategy:</strong> Read the claim carefully. Does the sample represent the population?<br><br><strong>Algebraic Method:</strong> Choice D is correct. The given estimated mean has an associated margin of error because from sample data, the population mean can’t be determined precisely. Rather, from the sample mean, an interval can be determined within which it’s plausible that the population’s mean is likely to lie. Since the estimated mean is 4.5 miles with an associated margin of error of 0.5 miles, it follows that between miles and miles, or between 4 and 5 miles, is plausibly the mean distance hiked for all visitors. Choices A, B, and C are incorrect. Based on the estimated mean, no determination can be made about the number of miles hiked for all visitors to the park.<br><br><strong>🪤 Trap Alert:</strong> Beware of biased samples or small sample sizes.",
            "type": "multiple-choice",
            "archetype": "Margin of error / confidence interval",
            "trapName": "Said ",
            "strategy": "The interval (estimate − margin) to (estimate + margin) is the plausible range.",
    ...
    "homework": [
        {
            ...
            "correctIndex": 2,
            "explanation": "<strong>SAT Strategy:</strong> Read the claim carefully. Does the sample represent the population?<br><br><strong>Algebraic Method:</strong> Choice C is correct. Because a random sample of the city council was polled, the proportion of the sample who supported the bill is expected to be approximately equal to the proportion of the total city council who supports the bill. Since 6 of the 20 polled, or 30%, supported the bill, it can be estimated that , or 15, city council members support the bill. Choice A is incorrect. This is the number of city council members in the sample who supported the bill. Choice B is incorrect and may result from a computational error. Choice D is incorrect. This is the number of city council members in the sample of city council members who were not polled.<br><br><strong>🪤 Trap Alert:</strong> Beware of biased samples or small sample sizes.",
            "type": "multiple-choice",
            "answer": "C",
            "archetype": "Random sample → generalise to population",
            "trapName": "Generalised beyond the sampled group",
        ...
        },
        {
            ...
            "correctIndex": 2,
            "explanation": "<strong>SAT Strategy:</strong> Read the claim carefully. Does the sample represent the population?<br><br><strong>Algebraic Method:</strong> Choice C is correct. The mean of the 5 samples is trees per acre. The best estimate for the total number of trees in the forest is the product of the mean number of trees per acre in the sample and the total number of acres in the forest. This is (56)(253) = 14,168, which is between 13,500 and 14,500. Choice A is incorrect and may result from multiplying the minimum number of trees per acre in the sample, 45, by the number of acres, 253. Choice B is incorrect and may result from multiplying the median number of trees per acre in the sample, 52, by the number of acres, 253. Choice D is incorrect and may result from multiplying the maximum number of trees per acre in the sample, 73, by the number of acres, 253.<br><br><strong>🪤 Trap Alert:</strong> Beware of biased samples or small sample sizes.",
            "type": "multiple-choice",
            "archetype": "Random sample → generalise to population",
            "trapName": "Generalised beyond the sampled group",
            "strategy": "Compute the proportion in the sample (e.g., 6 out of 20 = 30%).",
        ...
        },
        {
            ...
            "correctIndex": 2,
            "explanation": "<strong>SAT Strategy:</strong> Read the claim carefully. Does the sample represent the population?<br><br><strong>Algebraic Method:</strong> Choice C is correct. In order to use a sample mean to estimate the mean for a population, the sample must be representative of the population (for example, a simple random sample). In this case, Tabitha surveyed 20 families in a playground. Families in the playground are more likely to have children than other households in the community. Therefore, the sample isn’t representative of the population. Hence, the sampling method is flawed and may produce a biased estimate. Choices A and D are incorrect because they incorrectly assume the sampling method is unbiased. Choice B is incorrect because a sample of size 20 could be large enough to make an estimate if the sample had been representative of all the families in the community.<br><br><strong>🪤 Trap Alert:</strong> Beware of biased samples or small sample sizes.",
            "type": "multiple-choice",
            "archetype": "Identifying bias / non-random samples",
            "trapName": "Accepted a flawed sample",
            "strategy": "Random selection from the target group → conclusion about the group is valid.",
    ...
    "exam": [
        {
            ...
            "correctIndex": 3,
            "explanation": "<strong>SAT Strategy:</strong> Read the claim carefully. Does the sample represent the population?<br><br><strong>Algebraic Method:</strong> Choice D is correct. The members of the city council wanted to assess opinions of all city residents. To gather an unbiased sample, the council should have used a random sampling design to select subjects from all city residents. The given survey introduced a sampling bias because the 500 city residents surveyed were all dog owners. This sample is not representative of all city residents because not all city residents are dog owners. Choice A is incorrect because when the sampling method isn’t random, there is no guarantee that the survey results will be reliable; hence, they cannot be generalized to the entire population. Choice B is incorrect because a larger sample of residents who are dog owners would not correct the sampling bias. Choice C is incorrect because a survey sample of entirely non–dog owners would likely have a biased opinion, just as a sample of dog owners would likely have a biased opinion.<br><br><strong>🪤 Trap Alert:</strong> Beware of biased samples or small sample sizes.",
            "type": "multiple-choice",
            "archetype": "Random sample → generalise to population",
            "trapName": "Generalised beyond the sampled group",
            "strategy": "Compute the proportion in the sample (e.g., 6 out of 20 = 30%).",
