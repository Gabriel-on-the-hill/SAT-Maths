const PLAYLIST = {
    ...
    "homework": [
        ...
        },
        {
            ...
            "answer": "A",
            "explanation": "Choice A is correct. In the figure shown, lines and are parallel if and only if a pair of corresponding angles are congruent. It's given that one angle has a measure of and that the corresponding angle has a measure of . Therefore, is sufficient to prove that lines and are parallel. Choice B is incorrect. The angle measuring and the angle measuring are alternate interior angles. Thus, if lines and are parallel, is equal to , not . Choice C is incorrect. The angle measuring and the angle measuring are vertical angles. Thus, , whether lines and are parallel or not. Assessment SAT Test Math Domain Geometry and Trigonometry Skill Lines, angles, and triangles Difficulty 𝓁",
            "type": "multiple-choice",
            "desmos_strategy": "",
            "archetype": "Parallel lines cut by a transversal",
            "trapName": "Treated non-parallel lines as parallel",
    ...
    "exam": [
        ...
        },
        {
            ...
            "answer": "B",
            "explanation": "Choice B is correct. It’s given that the three points shown define a circle, so the center of that circle is an equal distance from each of the three points. The point is halfway between the points and and is a distance of units from each of those two points. The point is also a distance of units from . Because the point is the same distance from all three given points, it must be the center of the circle. The radius of a circle is the distance from the center to any point on the circle. Since that distance is , it follows that the radius of the circle is . The circumference of a circle with radius is equal to . It follows that the circumference of the circle is , or . It's given that the circumference of the circle is . Therefore, the value of is . Choice A is incorrect. This is the radius of the circle, not the value of in the expression . Assessment SAT Test Math Domain Geometry and Trigonometry Skill Area and volume Difficulty",
            "type": "multiple-choice",
            "desmos_strategy": "Graph the circle equation in Desmos. The center (h, k) and radius r can be found visually by inspecting the graph or using sliders.",
            "archetype": "Circle: area, circumference, sector",
            "trapName": "Used diameter as radius",
