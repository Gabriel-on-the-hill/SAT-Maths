(function () {
    const APP_ID = 'Analytical_Geometry_App';
    const state = {
    ...
    function startPlaylist(moduleKey) {
        ...
        // 1. Normalize playlist shape. Analytical_Geometry's data declares a flat object
        ...
        if (Array.isArray(raw)) {
            ...
            sourcePlaylist = [{
                ...
                title: 'Analytical Geometry & Trig',
                introText: 'Circles, right triangles, and trigonometry. Find the relationship first, then the value.',
                questions: raw
            }];
        } else {
            sourcePlaylist = [];
